...
namespace RE
{
	class GFxMovieRoot : public GFxMovieView
	{
		...
		void                        CreateObject(GFxValue* a_value, const char* a_className = nullptr, const GFxValue* a_args = nullptr, std::uint32_t a_numArgs = 0) override;                                                               // 0D - Creates an instance of ActionScript Object.
		void                        CreateArray(GFxValue* a_value) override;                                                                                                                                                      // 0E - Creates an instance of an ActionScript Array object.
		void                        CreateFunction(GFxValue* a_value, GFxFunctionHandler* a_fc, void* a_userData = nullptr) override;                                                                                                   // 0F - Creates a function object that wraps a C++ function.
