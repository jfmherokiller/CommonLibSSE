...
namespace RE
{
	...
	public:
		...
		virtual void           SetVertexData(const void* a_vertices, std::int32_t a_numVertices, VertexFormat a_vtxFmt, CacheProvider* a_cache = nullptr) = 0;                                                                                                                          // 1B
		virtual void           SetIndexData(const void* a_indices, std::int32_t a_numIndices, IndexFormat a_idxFmt, CacheProvider* a_cache = nullptr) = 0;                                                                                                                              // 1C
		...
		virtual void           FillStyleGouraud(GouraudFillType a_fillType, const FillTexture* a_texture0 = nullptr, const FillTexture* a_texture1 = nullptr, const FillTexture* a_texture2 = nullptr) = 0;                                                                                         // 25
		virtual void           DrawBitmaps(BitmapDesc* a_bitmapList, std::int32_t a_listSize, std::int32_t a_startIndex, std::int32_t a_count, const GTexture* a_texture, const Matrix& a_matrix, CacheProvider* a_cache = nullptr) = 0;                                                // 26
		virtual void           DrawDistanceFieldBitmaps(BitmapDesc* a_bitmapList, std::int32_t a_listSize, std::int32_t a_startIndex, std::int32_t a_count, const GTexture* a_texture, const Matrix& a_matrix, const DistanceFieldParams& a_params, CacheProvider* a_cache = nullptr);  // 27
		...
		virtual void           GetRenderStats(Stats* a_stats, bool a_resetStats = false) = 0;                                                                                                                                                                                         // 2E
