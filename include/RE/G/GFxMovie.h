...
namespace RE
{
	...
	public:
		...
		virtual void          CreateObject(GFxValue* a_value, const char* a_className = nullptr, const GFxValue* a_args = nullptr, std::uint32_t a_numArgs = 0);                                                               // 0D - pure - Creates an instance of an ActionScript Object.
		virtual void          CreateArray(GFxValue* a_value);                                                                                                                                                      // 0E - pure - Creates an instance of an ActionScript Array object.
		virtual void          CreateFunction(GFxValue* a_value, GFxFunctionHandler* a_fc, void* a_userData = nullptr);                                                                                                   // 0F - pure - Creates a function object that wraps a C++ function.
