...
namespace RE
{
	...
	public:
		...
		ObjectRefHandle         RemoveItem(TESBoundObject* a_item, std::int32_t a_count, ITEM_REMOVE_REASON a_reason, ExtraDataList* a_extraList, TESObjectREFR* a_moveToRef, const NiPoint3* a_dropLoc = nullptr, const NiPoint3* a_rotate = nullptr) override;  // 056
		...
		virtual ObjectRefHandle      DropObject(const TESBoundObject* a_object, ExtraDataList* a_extraList, std::int32_t a_count, const NiPoint3* a_dropLoc = nullptr, const NiPoint3* a_rotate = nullptr);                       // 0CB
